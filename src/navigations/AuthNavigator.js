...
import { Lessons, Lessons2, Lessons3, Lessons5, Lessons6, Lessons7, Lessons8, Login, Points, PrivacyPolicy,Quiz1,Quiz2,Quiz3,Quiz5,Quiz6,Quiz7,Quiz8,Summary,TermsAndConditions} from '../screens';
...
const AuthNavigator = () => {
  ...
  return (
    ...
    {/* AUTH SCREENS*/ }
      ...
      <Stack.Screen name={ROUTES.SUMMARY} component={Summary} options={{headerShown: false}}/>
