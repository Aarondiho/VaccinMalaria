...
const Quiz2 = () => {
    ...
    const questions = [
      {
          question: ' Quel est le nom du vaccin antipaludique ?',

          options: [ 'MalariaVac','Mosquirix RTS,S', 'MAL-123'],

          correctAnswer: 'Mosquirix RTS,S',
      },
      {
          question: 'Quelle est la présentation du vaccin contre le paludisme?',

          options: ['2 flacons accolés à anneaux rouge et bleu', ' un flacon à anneau blanc ', '2 flacons accolés avec anneaux rouge et vert '],
          correctAnswer: '2 flacons accolés avec anneaux rouge et vert ',

      },
      {
        question: 'Comment conserver le vaccin contre le paludisme ?',

        options: ['Au réfrigérateur entre +2°c et +8°C ', 'Au réfrigérateur à moins de 0°c ', 'sur une étagère exposé à la lumière'],

          correctAnswer: 'Au réfrigérateur entre +2°c et +8°C ',
      }
    ];
