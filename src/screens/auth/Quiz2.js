    ...
    const Quiz2 = () => {
        ...
        const questions= [
            {
                question:'Quelle est la présentation du vaccin antipaludique, RTS,S ou Mosquirix?',
                
                options: ['Un flacon de 5 doses (1 ml/dose)', 'Un flacon de 2 doses (0,5 ml/dose)', 'Un flacon de 10 doses (0,2 ml/dose)','Un flacon de 3 doses (0,3 ml/dose)'],
                
                  correctAnswer:'Un flacon de 2 doses (0,5 ml/dose)',
            },
            {
                question:'À quelle température le vaccin antipaludique, RTS,S, doit-il être conservé ?',
                
                options: ['Entre -20°C et -10°C', 'Entre 0°C et 2°C', 'Entre +2°C et +8°C','Entre +10°C et +15°C'],
                correctAnswer:'Entre +2°C et +8°C',
                
            },
            {
                question:'A quoi est-ce que le vaccin antipaludique, RTS,S est-il sensible (parmi les choix proposés) ?',
                
                options: ["Sensible au gel et à la lumière", "Sensible à la chaleur et à l'humidité", "Sensible au froid et à l'air","Sensible à la lumière et à l'humidité"],
                
                correctAnswer:"Sensible au gel et à la lumière",
            },
          
            {
                question:'Que contient le flacon à anneau vert dans le vaccin antipaludique, RTS,S ?',
                
                options: ["Contient l'antigène RTS,S", "Contient le diluant AS01", "Contient le vaccin lyophilisé","Contient le stabilisateur"],
                
                correctAnswer: "Contient le diluant AS01",
            },
            {
                question:'Quel est le nombre de doses recommandé pour le vaccin contre le paludisme pour une protection optimale ?',
                
                  options: ['2 doses', '3 doses', '4 doses','5 doses'],
                correctAnswer:'4 doses',
    
            },
            {
                question:'Quelle est la politique concernant les flacons entamés du vaccin Vaccin antipaludique, RTS,S ?',
                
                options: ['Doivent être utilisés dans les 24 heures ', 'Doivent être utilisés dans les 12 heures', "Doivent être éliminés 6 heures après reconstitution ou à la fin d'une séance de vaccination",' Doivent être utilisés dans les 2 heures'],
    
                correctAnswer:"Doivent être éliminés 6 heures après reconstitution ou à la fin d'une séance de vaccination",
            }
          ];
        ...
        useEffect(() => {
            ...
            const checkCooldown = async () => {
                try {
                    const lastAttemptTime2 = await AsyncStorage.getItem('lastAttemptTime2');
                    if (lastAttemptTime2) {
                        const currentTime = new Date().getTime();
                        const timeDifference = currentTime - parseInt(lastAttemptTime2);
        ...
        const startCooldown = async () => {
            try {
                const currentTime = new Date().getTime();
                await AsyncStorage.setItem('lastAttemptTime2', JSON.stringify(currentTime));
                setIsCooldownActive(true);
            } catch (error) {
            ...
            <SafeAreaView className="flex-1">
                <View className="flex-1 bg-bg-one justify-center">
                    <View className="font-sans flex-row items-center mt-10">
                        ...
                        <Text className="font-sans text-2xl font-bold text-black">Questions Module 2</Text>
                    </View>
