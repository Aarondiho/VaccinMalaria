  ...
  useEffect(() => {
      ...
      const unsubscribe = navigation.addListener('focus', () => {
        ...
        const initializeData = async () => {
          ...
          const storedScreen1 = await AsyncStorage.getItem("screen2");
    ...
    const goToNextSlide = () =>{
      ...
      AsyncStorage.setItem("screen2", JSON.stringify(screen1 + 1));
        ...
        <ImageBackground 
                ...
                >
                  ...
                  <View>
                    ...
                    <Text className="font-sans text-4xl text-white mt-24 mx-4">  3 & 4
                      </Text>
                  </View>
