        ...
        <SafeAreaView className="flex-1">
            <View className="flex-1 bg-bg-one justify-center">
                ...
                >
                    <View style={styles.modalContainer}>
                        <View style={styles.modalContent}>
                            <Text style={styles.modalTitle}>Résultat et Corrections</Text>
                            <Text style={styles.modalScore}>Note Obtenue : {score.toFixed(2)}%</Text>
                            {questions.map((item, index) => (
                                <View key={index} style={styles.correctionItem}>
                                    ...
                                    {answers[index] !== item.correctAnswer && (
                                        <Text style={styles.correctAnswer} className="text-blue-900 mt-2 font-sans" >Correction : {item.correctAnswer}</Text>
                                    )}
